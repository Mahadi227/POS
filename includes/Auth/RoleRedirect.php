...
class RoleRedirect
{
    ...
    public static function publicPath(string $roleName): string
    {
        return match (self::slug($roleName)) {
            ...
            'warehouse_manager', 'inventory_officer', 'receiving_officer', 'dispatch_officer' => 'warehouse/index.php',
    ...
    public static function workspaceForRole(string $roleSlug): string
    {
        return match ($roleSlug) {
            ...
            'warehouse_manager', 'inventory_officer', 'receiving_officer', 'dispatch_officer' => 'warehouse',

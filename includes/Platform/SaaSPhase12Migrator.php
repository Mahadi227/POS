...
/**
 * SaaS Phase 12 — platform broadcasts and SMS delivery log.
 */
final class SaaSPhase12Migrator
{
    private static bool $done = false;

    public const VERSION = '030_saas_phase12';
    ...
    {
        $path = dirname(__DIR__) . '/Database/migrations/030_platform_communications.sql';
        if (!is_file($path)) {
            return;
        }
        ...
        foreach (array_filter(array_map('trim', explode(';', $sql))) as $statement) {
            ...
            try {
                ...
                error_log('SaaSPhase12Migrator: ' . $e->getMessage());
            }
        }
    }

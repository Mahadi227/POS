...
/** SaaS Phase 16 — platform backup registry. */
final class SaaSPhase16Migrator
{
    private static bool $done = false;

    public const VERSION = '034_platform_backups';
    ...
    {
        $path = dirname(__DIR__) . '/Database/migrations/034_platform_backups.sql';
        if (!is_file($path)) {
            return;
        }
        ...
        foreach (array_filter(array_map('trim', explode(';', $sql))) as $statement) {
            ...
            try {
                ...
                error_log('SaaSPhase16Migrator: ' . $e->getMessage());
            }
        }
    }

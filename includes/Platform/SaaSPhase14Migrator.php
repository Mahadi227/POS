...
/**
 * SaaS Phase 14 — platform settings and application logs.
 */
final class SaaSPhase14Migrator
{
    private static bool $done = false;

    public const VERSION = '032_saas_phase14';
    ...
    {
        $path = dirname(__DIR__) . '/Database/migrations/032_platform_settings_logs.sql';
        if (!is_file($path)) {
            return;
        }
        ...
        foreach (array_filter(array_map('trim', explode(';', $sql))) as $statement) {
            ...
            try {
                ...
                error_log('SaaSPhase14Migrator: ' . $e->getMessage());
            }
        }
    }

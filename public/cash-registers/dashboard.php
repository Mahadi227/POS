...
$pageI18n = cr_i18n([
    ...
    'cr_live_monitor', 'cr_kpi_sections', 'cr_registers_open_pct',
    'cr_time_just_now', 'cr_time_minutes_ago', 'cr_time_hours_ago',
]);
...
<section class="cr-dash-hero" aria-labelledby="crDashHeroTitle">
    <div class="cr-dash-hero__body">
        <div class="cr-dash-hero__top">
            <p class="cr-dash-hero__eyebrow" id="crDashHeroTitle"><?php echo __t('cr_dashboard_subtitle', 'admin'); ?></p>
            <span class="cr-dash-hero__live" id="crHeroLive" aria-live="polite">
                <span class="cr-dash-hero__live-dot"></span>
                <span class="cr-dash-hero__live-text"><?php echo __t('cr_live_monitor', 'admin'); ?></span>
            </span>
        </div>
        <div class="cr-dash-hero__progress-wrap" aria-hidden="true">
            <div class="cr-dash-hero__progress-track">
                <div class="cr-dash-hero__progress-bar" id="crHeroProgressBar"></div>
            </div>
            <span class="cr-dash-hero__progress-label" id="crHeroProgressLabel">—</span>
        </div>
...
<div class="cr-dash-kpi-switch" role="tablist" aria-label="<?php echo htmlspecialchars(__t('cr_kpi_sections', 'admin'), ENT_QUOTES, 'UTF-8'); ?>">
    <button type="button" class="cr-dash-kpi-switch__btn is-active" role="tab" aria-selected="true" data-cr-kpi-tab="ops" id="crTabOps">
        <span class="material-icons-round">tune</span>
        <span><?php echo __t('cr_section_operations', 'admin'); ?></span>
    </button>
    <button type="button" class="cr-dash-kpi-switch__btn" role="tab" aria-selected="false" data-cr-kpi-tab="cash" id="crTabCash">
        <span class="material-icons-round">account_balance</span>
        <span><?php echo __t('cr_section_cash_flow', 'admin'); ?></span>
    </button>
    <button type="button" class="cr-dash-kpi-switch__btn" role="tab" aria-selected="false" data-cr-kpi-tab="coll" id="crTabColl">
        <span class="material-icons-round">payments</span>
        <span><?php echo __t('cr_section_collections', 'admin'); ?></span>
    </button>
</div>

<div class="cr-dash-sections">
    <section class="cr-dash-section is-active" data-cr-section="ops" aria-labelledby="crSecOps" role="tabpanel">
    ...
    <section class="cr-dash-section" data-cr-section="cash" aria-labelledby="crSecCash" role="tabpanel">
        <header class="cr-dash-section__head">
    ...
    <section class="cr-dash-section" data-cr-section="coll" aria-labelledby="crSecColl" role="tabpanel">
        <header class="cr-dash-section__head">

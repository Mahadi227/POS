<?php
$activePage = 'voids';
$bodyClass = 'mgr-page mgr-pro-page mgr-approvals-page mgr-voids-page ad-page';
$pageCss = ['approvals.css'];
$pageScripts = ['approvals-filter.js'];

require __DIR__ . '/../includes/auth-guard.php';

$pageTitle = __t('voids_title', 'manager');
$pageI18n = [];
foreach ([
    'loading', 'load_error', 'last_updated', 'menu', 'nav_dashboard', 'nav_live', 'nav_shifts',
    'nav_team', 'nav_approvals', 'nav_inventory', 'nav_reports',
    'voids_intro', 'voids_panel_title', 'voids_refresh_hint',
    'stat_voids_pending', 'stat_voids_total_amount', 'stat_voids_avg_amount',
    'subnav_queue', 'filter_returns', 'filter_discounts', 'filter_voids',
    'type_void', 'approve_btn', 'reject_btn', 'approve_prompt', 'reject_prompt', 'no_reason',
    'approved_ok', 'rejected_ok', 'action_error', 'no_pending_voids',
] as $key) {
...
<nav class="mgr-approvals-subnav" aria-label="<?php echo htmlspecialchars(__t('nav_approvals', 'manager'), ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <a href="<?php echo $mgrPrefix; ?>approvals/voids.php" class="mgr-approvals-subnav__item mgr-approvals-subnav__item--accent">
...
<div class="mgr-page-intro mgr-approvals-intro">
    <span class="material-icons-round">block</span>
    <p><?php echo __t('voids_intro', 'manager'); ?></p>
</div>

<div class="mgr-approvals-summary mgr-voids-summary ad-stat-cards" id="apprFilterSummary">
    <div class="card stat-card mgr-kpi ad-stat-card is-loading">
        <div class="card-icon warning"><span class="material-icons-round">block</span></div>
        <div class="card-info">
            <h3><?php echo __t('stat_voids_pending', 'manager'); ?></h3>
    ...
    <div class="card stat-card mgr-kpi ad-stat-card is-loading">
        ...
        <div class="card-info">
            <h3><?php echo __t('stat_voids_total_amount', 'manager'); ?></h3>
    ...
    <div class="card stat-card mgr-kpi ad-stat-card is-loading">
        ...
        <div class="card-info">
            <h3><?php echo __t('stat_voids_avg_amount', 'manager'); ?></h3>
            <h2 id="apprFilterAvg">—</h2>
        </div>
    </div>
</div>

<p class="mgr-approvals-hint"><?php echo __t('voids_refresh_hint', 'manager'); ?></p>

<section class="card mgr-panel mgr-approvals-panel">
    <div class="mgr-panel-head">
        <h2><span class="material-icons-round">block</span> <?php echo __t('voids_panel_title', 'manager'); ?></h2>
        <span class="mgr-count" id="apprFilterListCount">—</span>
    </div>
    <div class="mgr-workspace mgr-approvals-list mgr-approvals-filter-root"
         id="approvalsVoidsRoot"
         data-approval-filter="void"
         data-empty-key="no_pending_voids"
         data-type-label-key="type_void"
         data-type-icon="block"
         data-badge-class="mgr-badge--off">

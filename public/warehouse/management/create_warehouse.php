...
<section class="wh-wh-form-hero" aria-labelledby="whWhFormTitle">
    <div class="wh-wh-form-hero__intro">
        <h2 class="wh-wh-form-hero__title" id="whWhFormTitle"><?php echo __t('wh_wh_new', 'warehouse'); ?></h2>
        <p class="wh-wh-form-hero__sub"><?php echo __t('wh_wh_form_create_subtitle', 'warehouse'); ?></p>
...
<div id="whWhFormRoot" class="wh-wh-form-root" data-mode="create" data-warehouse-id="0">

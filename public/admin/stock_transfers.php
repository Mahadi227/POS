...
<head>
    ...
    <title>Transferts de stock — RetailPOS</title>
...
<body>
            ...
            <header class="top-header">
                <div class="header-left" style="display:flex;align-items:center;gap:16px;">
                    ...
                    <div>
                        ...
                        <p class="date-display" id="transfersDate">—</p>
                    </div>
                </div>
                <div class="header-right">
                    <button type="button" class="ad-refresh-btn" id="refreshTransfers" title="Actualiser">
            ...
            <div class="dashboard-scroll-area">
                <div class="card table-widget">
                    <div class="inv-table-meta">
                        <span>Transferts inter-branches et inter-entrepôts.</span>
                    </div>
                    <div class="table-responsive">
                        <table class="modern-table">
                            ...
                            <tbody id="stockTransfersBody">
                                <tr>
                                    <td colspan="8" class="ad-empty-row">Chargement des transferts…</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    <script>
        ...
        document.getElementById('transfersDate').textContent = new Date().toLocaleDateString('fr-FR', {
            weekday: 'long',
            day: 'numeric',
            month: 'long',
            year: 'numeric'

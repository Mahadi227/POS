...
?>
<div class="card list-widget ad-notif-alerts-card">
    ...
    <div id="notifAlertsWidget" class="ad-notif-alerts-body">
        <p class="ad-empty-row"><?php echo __t('loading', 'notifications'); ?></p>
    </div>
</div>

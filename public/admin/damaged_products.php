...
<head>
    ...
    <title>Produits endommagés — RetailPOS</title>
...
<body>
        ...
        <main class="main-content">
            <header class="top-header">
                <div class="header-left" style="display:flex;align-items:center;gap:16px;">
                    ...
                    <div>
                        <h1>Produits endommagés</h1>
                        <p class="date-display" id="damagedDate">—</p>
                    </div>
                </div>
                <div class="header-right">
                    <button type="button" class="ad-refresh-btn" id="refreshDamaged" title="Actualiser">
            ...
            <div class="dashboard-scroll-area">
                <div class="card table-widget">
                    <div class="inv-table-meta">
                        <span>Gestion et audit des produits déclarés endommagés.</span>
                    </div>
                    <div class="table-responsive">
                        <table class="modern-table">
                            ...
                            <tbody id="damagedProductsBody">
                                <tr>
                                    <td colspan="7" class="ad-empty-row">Chargement des produits endommagés…</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    <script>
        ...
        document.getElementById('damagedDate').textContent = new Date().toLocaleDateString('fr-FR', {
            weekday: 'long',
            day: 'numeric',
            month: 'long',
            year: 'numeric'

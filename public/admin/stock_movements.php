...
<head>
    ...
    <title>Mouvements de stock — RetailPOS</title>
...
<body>
            ...
            <header class="top-header">
                <div class="header-left" style="display:flex;align-items:center;gap:16px;">
                    ...
                    <div>
                        ...
                        <p class="date-display" id="movementsDate">—</p>
                    </div>
                </div>
                <div class="header-right">
                    <button type="button" class="ad-refresh-btn" id="refreshMovements" title="Actualiser">
            ...
            <div class="dashboard-scroll-area">
                <div class="card table-widget">
                    <div class="inv-table-meta">
                        <span>Suivi des entrées, sorties, transferts et ajustements.</span>
                    </div>
                    <div class="table-responsive">
                        <table class="modern-table">
                            ...
                            <tbody id="stockMovementsBody">
                                <tr>
                                    <td colspan="9" class="ad-empty-row">Chargement des mouvements…</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    <script>
        ...
        document.getElementById('movementsDate').textContent = new Date().toLocaleDateString('fr-FR', {
            weekday: 'long',
            day: 'numeric',
            month: 'long',
            year: 'numeric'

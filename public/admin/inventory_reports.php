...
<head>
    ...
    <title>Rapports d'inventaire — RetailPOS</title>
...
<body>
        ...
        <main class="main-content">
            <header class="top-header">
                <div class="header-left" style="display:flex;align-items:center;gap:16px;">
                    ...
                    <div>
                        <h1>Rapports d'inventaire</h1>
                        <p class="date-display" id="reportsDate">—</p>
                    </div>
                </div>
                <div class="header-right">
                    <button type="button" class="ad-refresh-btn" id="refreshReports" title="Actualiser">
            ...
            <div class="dashboard-scroll-area">
                <div class="card table-widget">
                    <div class="inv-table-meta">
                        <span>Export PDF, Excel, impression et rapports financiers d'inventaire.</span>
                    </div>
                    <div class="inv-report-actions">
                        <button type="button" class="inv-btn inv-btn-primary">Exporter PDF</button>
                        <button type="button" class="inv-btn inv-btn-outline">Exporter Excel</button>
                        <button type="button" class="inv-btn inv-btn-outline">Imprimer</button>
                    </div>
                </div>
            </div>
        </main>
    ...
    <script>
        ...
        document.getElementById('reportsDate').textContent = new Date().toLocaleDateString('fr-FR', {
            weekday: 'long',
            day: 'numeric',
            month: 'long',
            year: 'numeric'

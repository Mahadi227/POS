...
$pageTitle = __t('wms_edit_warehouse', 'wms');
$extraScripts = ['wms-common.js', 'wms-warehouse-form.js'];
$pageI18n = wms_i18n([
    'wms_edit_wh_subtitle', 'wms_wh_code', 'wms_wh_name', 'wms_wh_type', 'wms_wh_address',
...
?>
<p class="cr-intro"><?php echo __t('wms_edit_wh_subtitle', 'wms'); ?></p>
<div class="cr-panel" id="wmsWhForm" data-mode="edit" data-warehouse-id="<?php echo $id; ?>"></div>

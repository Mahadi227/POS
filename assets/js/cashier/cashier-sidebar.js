/**
 * Cashier sidebar — mobile drawer only; desktop keeps a static sidebar
 */
(() => {
    if (window.__CASHIER_SIDEBAR_INIT__) return;
    window.__CASHIER_SIDEBAR_INIT__ = true;
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCashierSidebar);
    } else {
        initCashierSidebar();
    }
})();
